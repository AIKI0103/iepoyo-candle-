...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-r from-[#3e5a82] to-[#8d65a5] relative">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="mx-auto max-w-1xl text-center">
          {/* メインタイトル */}
          <h1 className="fade-in opacity-0 text-white mb-6 text-1xl leading-tight font-bold md:text-2xl">
            <span className="block">iepoyo candle🕯️</span>
            <span className="block text-gold-highlight">
              宮古島の手作り体験で、特別な思い出を
            </span>
          </h1>
